...
namespace TP_ITIL_9559.Migrations
{
    ...
    [Migration("20250620173032_RemoveConfigFromProblems")]
    partial class RemoveConfigFromProblems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TP_ITIL_9559.Data.Domain.Change", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TP_ITIL_9559.Data.Domain.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TP_ITIL_9559.Data.Domain.ConfigurationItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TP_ITIL_9559.Data.Domain.Incident", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TP_ITIL_9559.Data.Domain.Problem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TP_ITIL_9559.Data.Domain.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ChangeIncident", b =>
                {
                    b.HasOne("TP_ITIL_9559.Data.Domain.Change", null)
                        .WithMany()
                        .HasForeignKey("ChangesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TP_ITIL_9559.Data.Domain.Incident", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ChangeProblem", b =>
                {
                    ...
                    b.HasOne("TP_ITIL_9559.Data.Domain.Problem", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TP_ITIL_9559.Data.Domain.Change", b =>
                {
                    b.HasOne("TP_ITIL_9559.Data.Domain.User", "AssignedUser")
                        .WithMany("AssignedChanges")
                        .HasForeignKey("AssignedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TP_ITIL_9559.Data.Domain.ConfigurationItem", "ConfigurationItem")
                        .WithMany()
                        .HasForeignKey("ConfigurationItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TP_ITIL_9559.Data.Domain.User", "User")
                        .WithMany("Changes")
